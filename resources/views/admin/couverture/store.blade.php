...
@section('content')
<div class="container">
    <form action="{{route('couverture.store',['couverture' => $couverture->id]) }}" method="post" enctype="multipart/form-data">
    @method('PATCH')
    @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input name="petit_titre" type="texte" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">gros titre</label>
            <input name="gros_titre" type="texte" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
        </div>
        <div class="mb-3">
